...
void CMFCApplication18View::OnDraw(CDC* pDC)
{
	...
	/*ptset1[0] = CPoint(50, 50);
	ptset1[1] = CPoint(350, 50);
	ptset1[2] = CPoint(350, 300);
	ptset1[3] = CPoint(50, 300);
	ptset1[4] = CPoint(50, 50);*/


	ptset1[0] = CPoint(250, 0);
	ptset1[1] = CPoint(50, 200);
	ptset1[2] = CPoint(450, 300);
	ptset1[3] = CPoint(250, 0);
